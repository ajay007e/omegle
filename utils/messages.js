...
const formatMessage = (username, text, extra = {isSystemGenerated:true}) => {
  return {
    ...
    info: {
      ...
      isUserActionMessage: 
        message_helper_functions.CHECK_USER_JOIN_MESSAGE(text) ||
        message_helper_functions.CHECK_USER_LEFT_MESSAGE(text) || 
        message_helper_functions.CHECK_USER_PRESENTATION_MESSAGE(text),
